...
function HelloButton(props) {
  ...
  const click = event => {
    ...
    alert("hellobutton clicked!! (with JSX)")
  }
...
class HelloButtonClass extends React.Component {
  ...
  constructor(props) {
    super(props);
    console.log("HelloButtonClass", props);
    this.click = this.click.bind(this)
  }
  click = event => {
    event.preventDefault();
    alert("HelloButtonClass clicked! (with jdx class)")
  }
  // 반드시 render 메소드를 오버라이드 해줘야한다..
  render() {
    return (
...
ReactDOM.render(
  <div>
    <Welcome message="Custom Component">
      <p>이것은 사용자 정의 컴포턴트입니다.</p>
    </Welcome>
    <HelloButton>React Function Button</HelloButton><br />
